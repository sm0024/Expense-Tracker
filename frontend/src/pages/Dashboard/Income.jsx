...
const Income = () => {
  ...
  const fetchIncomeDetails = async () => {
    ...
    try {
      ...
      if (responce.data && responce.data.incomes) {
        setIncomeData(responce.data.incomes);
  ...
  const deleteIncome = async (id) => {
    try {
      ...
      console.error("error deleting income:", error.responce?.data?.message || error.message);
    }
  };
